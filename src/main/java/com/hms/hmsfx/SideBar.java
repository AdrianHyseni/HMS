...
public class SideBar {
    ...
    public void sideBar(Button goToProfile, Button logout, Button goToSettings, Button goToRooms,Button home,Button apartments, Button makeReservation, Button reservationList, Button costList){
